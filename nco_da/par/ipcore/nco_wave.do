...
add wave -noupdate -color Yellow -format Analog-Step -radix decimal -scale 0.002 /nco_tb/sin_val

add wave -noupdate -divider -height 80 {cosine waveform}
add wave -noupdate -color Cyan -format Analog-Step -radix decimal -scale 0.002 /nco_tb/cos_val
